...
export default function AdminLayout() {
  ...
  return (
    <div className="flex h-screen bg-[#eef2f7] dark:bg-[#07090e] text-slate-800 dark:text-slate-100 overflow-hidden transition-colors duration-300">
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex flex-col w-64 bg-white/95 dark:bg-[#0e121a]/85 border-r border-slate-200/90 dark:border-white/10 p-5 h-screen relative z-20 backdrop-blur-xl shadow-sm dark:shadow-none">
        <div className="flex items-center gap-3 mb-6">
          <div className="bg-red-500/10 dark:bg-red-500/20 p-2.5 rounded-2xl border border-red-500/25 shadow-sm">
        ...
        <NavLink
          to="/dashboard"
          className="flex items-center gap-2 px-3 py-2 rounded-xl text-xs font-bold text-slate-600 dark:text-gray-300 hover:text-slate-900 dark:hover:text-white bg-slate-100/80 dark:bg-white/5 hover:bg-slate-200/80 dark:hover:bg-white/10 border border-slate-200/80 dark:border-white/5 transition-all mb-4"
        >
            ...
            <NavLink
              ...
              className={({ isActive }) => 
                `flex items-center space-x-3 px-3.5 py-2.5 rounded-xl transition-all text-xs font-semibold ${
                  isActive 
                    ? 'bg-red-500 text-white font-bold shadow-md shadow-red-500/25 dark:bg-red-500/25 dark:text-red-400 dark:border dark:border-red-500/40' 
        ...
        <div className="pt-4 mt-auto border-t border-slate-200 dark:border-white/10 space-y-2">
          <NavLink
            ...
            className="flex items-center gap-3 p-2.5 rounded-xl bg-slate-50/80 dark:bg-white/5 hover:bg-slate-100 dark:hover:bg-white/10 border border-slate-200/80 dark:border-white/10 transition-all group"
          ...
          <button 
            ...
            className="flex items-center space-x-3 px-3 py-2 w-full rounded-xl text-red-600 hover:bg-red-500/10 transition-colors text-xs font-bold"
          >
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden relative">
        {/* Topbar */}
        <header className="h-16 flex items-center justify-between px-4 sm:px-6 md:px-8 border-b border-slate-200/90 dark:border-white/10 bg-white/85 dark:bg-[#07090e]/85 backdrop-blur-xl z-30 shadow-sm dark:shadow-none">
          ...
          <div className="flex items-center gap-3">
            ...
            <NavLink
              to="/dashboard"
              className="flex items-center gap-1.5 text-xs font-bold text-slate-600 dark:text-gray-300 bg-white hover:bg-slate-50 dark:bg-white/5 dark:hover:bg-white/10 border border-slate-200/90 dark:border-white/10 px-3 py-1.5 rounded-xl transition-all shadow-sm dark:shadow-none"
            >
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-6 pb-4 border-b border-slate-200 dark:border-white/10">
                <div className="flex items-center gap-2.5">
                  <div className="bg-red-500/10 dark:bg-red-500/20 p-2 rounded-xl border border-red-500/25">
                    <ShieldAlert className="w-5 h-5 text-red-500" />
                  </div>
                  <div>
              ...
              <div className="flex items-center justify-between mb-3 p-3 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10">
